/*
To play with the example copy the content of this file to the main index.js file in the root folder.

A basic example of sprite drawn to screen using the canvas.
The sprite can be rotated towards mouse position and fires bullet towards mouse position.
Has a simple game loop that draws frames at given frames/sec.
